...
function List() {
  ...
  const items = [
    { id: 1, name: "Tomato", vegetarian: true, price: 2.5 },
    { id: 2, name: "Mushrooms", vegetarian: true, price: 3.5 },
    { id: 3, name: "Pepperoni", vegetarian: false, price: 5.0 },
  ...
  const liStyle = (isSelected) => ({
    ...
    listStyleType: "none",
    cursor: "pointer",
    color: isSelected ? "var(--medium)" : "var(--darkest)",
  });
